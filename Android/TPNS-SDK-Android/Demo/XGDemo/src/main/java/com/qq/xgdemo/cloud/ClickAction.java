...
public class ClickAction {
    ...
    public static final int TYPE_INTENT_WITH_ACTION = 5;
    public static final int TYPE_INTENT_WITH_DATA = 6;
    ...
    public boolean isValid() {
        if (m_actionType < TYPE_ACTIVITY || m_actionType > TYPE_INTENT_WITH_ACTION)
            return false;
