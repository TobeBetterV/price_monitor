...
//import com.tencent.android.tpush.crossIPC.IPCManager;
...
public class SettingActivity extends Activity {
    ...
    private void initCustomPushNotificationBuilder(Context context) {
        ...
        build.setLayoutId(R.layout.notification_bak);
        // 设置自定义通知内容id
...
//                            Log.e("MtaSDK", "b:"  + b);
//                        } catch (Exception ex) {
//                            StatServiceImpl.sendTryCatchException(context, "test", ex);
//                            StatServiceImpl.send3rdCaughtException(context, "3part", ex);
//                        }
                    }
                });
        ...
        findViewById(R.id.Button_setTags).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ctx != null) {
                            ...
                            layout.setOrientation(LinearLayout.VERTICAL);
                            final EditText textviewGid = new EditText(ctx);
                            textviewGid.setHint("请输入多个标签，空格间隔");
                            layout.addView(textviewGid);

                            AlertDialog.Builder builder = new AlertDialog.Builder(
                                    ctx);
                            builder.setView(layout);
                            builder.setPositiveButton("设置多个标签",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(
                                            ...
                                            if (text != null
                                                ...
                                                XGPushManager.setTags(getApplicationContext(),
                                                        "setTags:" + System.currentTimeMillis(),
                                                        tagsSet);
                                            }
                                        }
                                    });
        ...
        findViewById(R.id.Button_addTags).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ctx != null) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(
                                    ctx);
                            builder.setView(layout);
                            builder.setPositiveButton("增加多个标签",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(
                                            ...
                                            if (text != null
                                                ...
                                                String[] tags = text.split(" ");
                                                Set<String> tagsSet = new HashSet<>(Arrays.asList(tags));
                                                XGPushManager.addTags(getApplicationContext(),
                                                        "addTags:" + System.currentTimeMillis(),
                                                        tagsSet);
                                            }
                                        }
                                    });
        ...
        findViewById(R.id.Button_delTags).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ctx != null) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(
                                    ctx);
                            builder.setView(layout);
                            builder.setPositiveButton("删除多个标签",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(
                                            ...
                                            if (text != null
                                                ...
                                                String[] tags = text.split(" ");
                                                Set<String> tagsSet = new HashSet<>(Arrays.asList(tags));
                                                XGPushManager.deleteTags(getApplicationContext(),
                                                        "delTags:" + System.currentTimeMillis(),
                                                        tagsSet);
                                            }
                                        }
                                    });
        ...
        findViewById(R.id.Button_cleanTags).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        XGPushManager.cleanTags(getApplicationContext(),
                                "cleanTags:" + System.currentTimeMillis());
                    }
                });
        ...
        findViewById(R.id.Button_clearCache).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String dateStr = df.format(new Date(System.currentTimeMillis() + 60 * 1000));

                        String[] tmp =dateStr.split("-");

                        Log.i("xg.demo.test", "LocalMessage Date:" + tmp[0]
                                + ", Hour:" + tmp[1] + ", Min:" + tmp[2]);
                        ...
                        local_msg.setContent("ww");
                        // 设置消息日期，格式为：20140502
                        local_msg.setDate(tmp[0]);
                        // 设置消息触发的小时(24小时制)，例如：22代表晚上10点
                        local_msg.setHour(tmp[1]);
                        // 获取消息触发的分钟，例如：05代表05分
                        local_msg.setMin(tmp[2]);
...
//                        IPCManager.getInstance(context).init();
//                        IPCManager.getInstance(context).tryWakeUpApp("com.qq.xgdemo");
