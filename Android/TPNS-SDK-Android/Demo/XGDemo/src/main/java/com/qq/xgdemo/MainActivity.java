...
public class MainActivity extends Activity implements OnItemClickListener,
	...
	private String ACTION_REGISTER_TPUSH_RESULT = "com.tencent.android.xg.vip.action.REGISTER.RESULT.V4";
	@Override
...
//		XGPushConfig.setMzPushAppKey(this, "484a31262cf24dc9b568b5445d9e0495");
	...
	private void showSpinner() {
		...
		action_device_token.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent test = new Intent(ACTION_REGISTER_TPUSH_RESULT);
				test.putExtra("test", 1);
				getApplicationContext().sendBroadcast(test);
				pw.dismiss();
